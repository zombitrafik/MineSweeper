...
public class QRoom extends EntityPathBase<Room> {
    ...
    public final NumberPath<Integer> minRating = createNumber("minRating", Integer.class);
    ...
    public final NumberPath<Integer> playersCount = createNumber("playersCount", Integer.class);
